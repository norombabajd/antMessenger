...
johndaniel = Profile(dsuserver='168.235.86.101',username='johndanieln', password='zotzot9148')
johndaniel_online = DirectMessenger(dsuserver=johndaniel.dsuserver, username=johndaniel.username, password=johndaniel.password)
msg = Message('maybejohndaniel', 'yooo!')
johndaniel_online.send(msg.entry, msg.recipient)

msg1 = Message('maybejohndaniel', 'hello?!')
